  ...
  return (
    <div className="space-y-4">
      ...
      {commentProviders.map((provider) => (
        <div key={provider} className="rounded-xl border border-ink-200 bg-[#f7f8fa] dark:bg-ink-950 dark:border-ink-800 p-3">
          ...
          <textarea
            ...
            className="min-h-[72px] w-full resize-none rounded-lg border border-ink-200 bg-white px-3 py-2 text-sm outline-none dark:bg-ink-900 dark:border-ink-800 dark:text-white"
          />
        </div>
      ))}
    </div>
